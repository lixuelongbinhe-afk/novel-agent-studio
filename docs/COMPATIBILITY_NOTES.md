...
- The supported v2.2.3 Windows installer and portable ZIP require Windows x64 plus Microsoft Edge or WebView2 Runtime and pass packaged GUI lifecycle checks.
