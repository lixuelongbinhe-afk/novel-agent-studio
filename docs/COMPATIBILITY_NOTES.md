...
- The supported v2.2.8 Windows installer and portable ZIP require Windows x64 plus Microsoft Edge or WebView2 Runtime. Release artifacts must pass packaged GUI lifecycle checks and carry build provenance.
