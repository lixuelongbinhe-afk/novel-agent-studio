...
- [x] 正式打包默认拒绝脏工作区和未带精确 `v2.2.7` 标签的提交。
...
- [x] 本地候选安装器编译通过，内嵌 payload SHA-256 校验通过，产品版本为 2.2.7.0。
...
产物必须由 `scripts/package-desktop.ps1` 在干净的 `v2.2.7` 标签提交上生成：

- `NovelAgentStudio-Setup-2.2.7.exe`
- `NovelAgentStudio-Portable-2.2.7.zip`
- `SHA256SUMS.txt`
